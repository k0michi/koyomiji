...
export default function AboutPage() {
  ...
  return (
    <>
      ...
      <div id="body">
        <h2>サイトについて</h2>
        <p>当サイト、<ruby>曆路<rp></rp><rt>こよみじ</rt><rp></rp></ruby>喫茶館 を運営している、<ruby>曆月<rp></rp><rt>れきづき</rt><rp></rp></ruby>こみち と申します。このサイトは、私が気まぐれに勉強したことを書いたり、日記を書いたり、創作したりするための場所です。プログラミングや英語、数学に関する内容が多いですが、これらに限らず私の興味のあることを取り扱っていきます。</p>
